...
public class Cena implements GLEventListener{    
    ...
    public void display(GLAutoDrawable drawable) {  
        ...
        */
        ...
        gl.glPushMatrix();
            //gl.glRotatef(getAnguloX(), 0, 1, 0);        
            gl.glColor3f(1,0,0);
            //desenha um círculo
            Bola bola = new Bola(0.05);
            bola.draw(gl);
        gl.glPopMatrix();
        
        gl.glPushMatrix();
            gl.glTranslatef(getAnguloX(), 0, 0);        
            gl.glColor3f(0,1,0);
            //desenha um círculo
            Barra barra = new Barra(0.05);
            barra.draw(gl);
        gl.glPopMatrix();
        ...
        /***
        gl.glPushMatrix();
            gl.glRotatef(getAnguloZ(), 0, 0, 1);
            gl.glColor3f(1,1,0);
            //desenha uma elipse
            Bola elipse = new Bola(0.4, 0.2);
            elipse.draw(gl);
        gl.glPopMatrix();
        ***/
        gl.glFlush();    
